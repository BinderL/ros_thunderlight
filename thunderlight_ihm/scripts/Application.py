...
#    add_strips.place(x= self.w - 80, y= self.h - 40)
    ...
    request_geometry = Button(self.frame, text="request geometry", command=self.request_geometry, width= 20)
#    add_strips.place(x= self.w - 80, y= self.h - 40)
    request_geometry.pack(side=LEFT, padx=5, pady=20)
